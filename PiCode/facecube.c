...
facelet_t cornerFacelet[8][3] = {{U9, R1, F3},
                                 {U7, F1, L3},
                                 {U1, L1, B3},
                                 {U3, B1, R3},
                                 {D3, F9, R7},
...
facelet_t edgeFacelet[12][2] = {{U6, R2},
                                {U8, F2},
                                {U4, L2},
                                {U2, B2},
                                {D6, R8},
...
facecube_t *get_facecube() {
    ...
    static const color_t f[54] = {U, U, U, U, U, U, U, U, U, R, R, R, R, R, R, R, R, R, F, F, F, F, F, F, F, F, F, D, D,
